...
strPlayFajrAzaanMP3Command = '{}/playAzaan.sh {}/Fozor_Azan.mp3 {}'.format(root_dir, root_dir, fajr_azaan_vol)
strPlayAzaanMP3Command = '{}/playAzaan.sh {}/Azan.mp3 {}'.format(root_dir, root_dir, azaan_vol)
